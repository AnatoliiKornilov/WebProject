      ...
      <section className={styles.features}>
        <div className="container">
          ...
          <div className={styles.featuresGrid}>
            ...
            <div className={styles.featureCard}>
              <div className={styles.featureIcon}>🔒</div>
              <h3 className={styles.featureTitle}>Контроль приватности</h3>
              <p className={styles.featureDescription}>
                Решайте, какие проекты показывать публично, а какие оставить приватными.
              </p>
            </div>
            ...
            <div className={styles.featureCard}>
              ...
              <p className={styles.featureDescription}>
                Находите вдохновение в работах других разработчиков и делитесь опытом.
              </p>
            </div>
            
            <div className={styles.featureCard}>
              <div className={styles.featureIcon}>📈</div>
              <h3 className={styles.featureTitle}>Аналитика просмотров</h3>
              <p className={styles.featureDescription}>
                Отслеживайте, кто просматривает ваше портфолио и какие проекты привлекают внимание.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className={styles.ctaContent}>
            <h2 className={styles.ctaTitle}>
              Готовы показать миру свои проекты?
            </h2>
            <p className={styles.ctaDescription}>
              Присоединяйтесь к тысячам разработчиков, которые уже создали свои портфолио на нашей платформе.
            </p>
            ...
            <div className={styles.stats}>
              <div className={styles.statItem}>
                ...
                <span className={styles.statLabel}>разработчиков</span>
              </div>
              <div className={styles.statItem}>
              ...
              <div className={styles.statItem}>
                ...
                <span className={styles.statLabel}>довольных пользователей</span>
              </div>
            </div>
          </div>
        </div>
