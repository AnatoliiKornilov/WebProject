      ...
      <div className={styles.info}>
        ...
        <div className={styles.stats}>
          <div className={styles.statItem}>
            <span className={styles.statValue}>{/* Здесь будет количество проектов */}5</span>
            <span className={styles.statLabel}>проектов</span>
          </div>
          <div className={styles.statItem}>
            <span className={styles.statValue}>2 года</span>
            <span className={styles.statLabel}>в DevPortfolio</span>
          </div>
        </div>
